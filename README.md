...
- 이재혁
	- 프로젝트 동안 Selenium과 MySql을 모듈화해서 연동시도하다 실패했습니다. 리팩토링해서 다음 프로젝트 전에 파이썬으로 모듈화에 대해 복습해야 된다 생각했습니다.

- 김도연
	- 프로젝트를 하며 지난 시간 배운 내용을 총 복습할 수 있었습니다. selenium에서 요소를 찾아 스크랩핑을 도전하면서 요소를 찾아갈 수 있었습니다. 앞으로 다양한 주소에서 데이터를 수집할 수 있는 방식을 이용해볼것입니다.

- 김영서 
	- 이번 프로젝트에서 배웠던 모든 것들을 사용하고 싶었지만 그렇지 못해 다음 프로젝트에서는 python으로 구현할 수 있는 함수들과 매서드를 다양하게 써보려고 합니다. 팀원들과의 소통을 통해 주제선정에서의 의견추합과 프로젝트가 진행되면서의 시행착오들을 해결하며 좋은 경험이 되었습니다.

 - 김정훈
   	- 프로젝트 주제에 대하여, 직접적인 소비자와 최종 사용자의 요구 조건을 만족하고 대응 할 수 있도록 프로젝트의 방향성을 선정하고 고려 하는 것의 중요성을 느꼈습니다. 이번 부트캠프에서 배운 커리큘럼을 적극 반영 하여 프로그래밍 언어를 구사하고, 프로젝트에 부합하는 간결한 방법을 모색하여 구현하는 것을 알게 되었습니다. 실무에서 많이 사용하는 office 프로그램들도 접목하여, 데이터 수집을 기본으로 더 많은 양의 데이터를 간결화 하여 처리 할 수 있을 것이라 생각되며, 구현하기 위해 더욱 다양항 방법을 앞으로 모색해 봐야 겠다는 생각을 하게 되었습니다.
